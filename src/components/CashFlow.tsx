...
- **Cartão Link:** ${formatCurrency(entries.cartaoLink)}
  ${entries.cartaoLink > 0 ? `  - Cliente: ${entries.clienteCartaoLink || 'Não informado'}` : ''}
  ${entries.cartaoLink > 0 ? `  - Parcelas: ${entries.parcelasCartaoLink || 1}x` : ''}
- **Boletos:** ${formatCurrency(entries.boletos)}
  ${entries.boletos > 0 ? `  - Cliente: ${entries.clienteBoletos || 'Não informado'}` : ''}
  ${entries.boletos > 0 ? `  - Parcelas: ${entries.parcelasBoletos || 1}x` : ''}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center h-auto sm:h-24 py-8 sm:py-0 space-y-4 sm:space-y-0">
              <div className="flex items-center space-x-6">
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 rounded-2xl flex items-center justify-center shadow-2xl transform hover:rotate-12 transition-all duration-300">
              ...
              <div className="flex items-center space-x-6">
                {isDemo && onBackToLanding ? (
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Voltar à Landing Page</span>
                  </button>
                ) : (
                  <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      {entries.cartaoLink > 0 && (
                        <div className="mt-3 space-y-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={entries.clienteCartaoLink}
                              onChange={(e) => handleEntryChange('clienteCartaoLink', e.target.value)}
                          ...
                          <div>
                            ...
                            <input
                              type="number"
                              min="1"
                              value={entries.parcelasCartaoLink === 0 ? '' : entries.parcelasCartaoLink}
                              onChange={(e) => handleEntryChange('parcelasCartaoLink', parseInt(e.target.value) || 0)}
                              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm transition-all duration-200 hover:border-blue-300 focus:shadow-lg"
                              placeholder="1"
                            />
                          </div>
                      ...
                      {entries.boletos > 0 && (
                        <div className="mt-3 space-y-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={entries.clienteBoletos}
                              onChange={(e) => handleEntryChange('clienteBoletos', e.target.value)}
                              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm transition-all duration-200 hover:border-blue-300 focus:shadow-lg"
                              placeholder="Nome do cliente"
                            />
                          </div>
                          <div>
                            ...
                            <input
                              type="number"
                              min="1"
                              value={entries.parcelasBoletos === 0 ? '' : entries.parcelasBoletos}
                              onChange={(e) => handleEntryChange('parcelasBoletos', parseInt(e.target.value) || 0)}
                              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm transition-all duration-200 hover:border-blue-300 focus:shadow-lg"
                              placeholder="1"
                            />
                          </div>
              ...
              <div className="border-t-4 border-black pt-4 mt-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-2xl text-red-600">
                    <strong>{formatCurrency(cancelamentos.reduce((total, c) => total + c.valor, 0))}</strong>
                  </span>
                </div>
              </div>
            </div>
